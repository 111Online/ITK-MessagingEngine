...
import OctopusConsortium.Models.Address;
import OctopusConsortium.Models.GPPractice;
import OctopusConsortium.Models.HaSC;
import OctopusConsortium.Models.CDA.InformantType;
import OctopusConsortium.Models.Patient;
import OctopusConsortium.Models.SubmitEncounterToServiceResponse;
...
public class SubmitEncounterToServiceResponseToRepeatCallerCDA_UK extends
	AbstractTransformer {
 ...
 * 
 *//*
public SubmitEncounterToServiceResponseToRepeatCallerCDA_UK() {	
	super();			
	this.registerSourceType(DataTypeFactory.create(OctopusConsortium.Models.SubmitEncounterToServiceResponse.class));
...
protected Object doTransform(Object src, String enc)
	...
	SubmitEncounterToServiceResponse msg = (SubmitEncounterToServiceResponse)src;
...
private POCDMT000002UK01Informant12 createInformantAsSelf(ObjectFactory of, SubmitEncounterToServiceResponse request)
{
...
private POCDMT000002UK01Informant12 createInformantRelatedEntity(ObjectFactory of, Address address, OctopusConsortium.Models.CDA.InformantType cdaPersonRelationshipType, String telephoneHome, String telephoneMobile)
{
	...
	{	
		...
		tel.setValue("tel:" + telephoneMobile);
	...
	if(telephoneHome!=null && !telephoneHome.isEmpty())
	{
		...
		tel.setValue("tel:" + telephoneHome);
		informant.getRelatedEntity().getTelecom().add(tel);
	}
	II e = of.createII();
...
private POCDMT000002UK01RecordTarget  CreateRecordTarget(ObjectFactory of, SubmitEncounterToServiceResponse request) throws OctopusConsortium.Core.InvalidMessageException {
...
private POCDMT000002UK01Custodian  CreateCustodian(ObjectFactory of) {
	...
	co.getName().getContent().add(CommonValues.ORGANISATION_NAME);
	ii = of.createII();
...
private POCDMT000002UK01Author CreateAuthor(ObjectFactory of)
{
	...
	on.getContent().add(CommonValues.ORGANISATION_NAME);
	ii = of.createII();
...
private POCDMT000002UK01StructuredBody createStructuredBody(ObjectFactory of,SubmitEncounterToServiceResponse message) throws InvalidHascException
{
...
private POCDMT000002UK01Entry createEntry(ObjectFactory of,SubmitEncounterToServiceResponse message)
{
	...
	device.getManufacturerModelName().setDisplayName("NHS Direct");
	//TODO: pull manufacturer, software and version from config file.
	device.setSoftwareName(of.createSC());
	device.getSoftwareName().setDisplayName("Message Engine ESB");
...
private POCDMT000002UK01Section  CreateDispositionSection(ObjectFactory of,SubmitEncounterToServiceResponse message) throws InvalidHascException
{
...
//file:///C:/111/NHS111%20DMS/NHS111%20DMS/Domains/Templates/Document%20files/NPFIT-000040_Section.htm
private POCDMT000002UK01Section  CreateSection(ObjectFactory of,SubmitEncounterToServiceResponse message) throws InvalidHascException
{
	POCDMT000002UK01Section  section = of.createPOCDMT000002UK01Section();
...
private POCDMT000002UK01EncompassingEncounter CreateEncompassingEncounter(ObjectFactory of,SubmitEncounterToServiceResponse msg)
{
