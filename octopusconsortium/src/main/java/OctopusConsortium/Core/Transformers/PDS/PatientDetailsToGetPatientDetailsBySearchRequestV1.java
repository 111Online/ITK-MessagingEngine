...
public class PatientDetailsToGetPatientDetailsBySearchRequestV1 extends
		AbstractTransformer {
	...
	public PatientDetailsToGetPatientDetailsBySearchRequestV1()
	{
		super();		
		this.registerSourceType(DataTypeFactory.create(IdentifyPatientRequest.class));
		//this.setReturnDataType(DataTypeFactory.create(QUPAMT000004GB01GetPatientDetailsBySearchRequestV10.class));
	}
