...
@XmlType(name = "TS")
@XmlSeeAlso({
    OctopusConsortium.Models.RCSGB.POCDMT200001GB02ClinicalDocument.EffectiveTime.class,
    IVXBTS.class,
    OctopusConsortium.Models.RCSGB.POCDMT200001GB02Author.Time.class,
    SXCMTS.class,
    OctopusConsortium.Models.RCSGB.COCDTP146246GB01Author1 .Time.class
})
public class TS
    extends QTY
{
