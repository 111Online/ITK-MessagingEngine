...
@XmlType(name = "INT")
@XmlSeeAlso({
    OctopusConsortium.Models.RCSGB.POCDMT200001GB02ClinicalDocument.VersionNumber.class,
    OctopusConsortium.Models.RCSGB.IVLINT.Low.class,
    OctopusConsortium.Models.RCSGB.IVLINT.High.class,
    OctopusConsortium.Models.RCSGB.POCDMT200001GB02ParentDocument.VersionNumber.class
})
public class INT
    extends QTY
{
